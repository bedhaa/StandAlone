...
Mobile.setText(findTestObject('StandAlone/2. Ubah Kata Sandi/android.widget.EditText0 - Kata sandi baru (1)'), 'qwerty', 0)

Mobile.tap(findTestObject('StandAlone/2. Ubah Kata Sandi/android.widget.ImageButton0'), 0)

Mobile.setText(findTestObject('StandAlone/2. Ubah Kata Sandi/android.widget.EditText1 - Konfirmasi kata sandi baru'), '', 0)
